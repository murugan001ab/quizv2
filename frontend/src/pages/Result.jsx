...
export default function Result() {
  ...
  // Backend stores answers as { "question_id_str": chosen_option_int }
  // Normalise to number keys so answers[q.id] always works
  const answers = {}
      ...
      <div className="fade-up-1" style={{ marginBottom: '1rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          {data.questions.map((q, i) => {
            const chosen  = answers[q.id]        // number | undefined
            const correct = q.correct_option      // number (0-3)
